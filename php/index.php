...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-light" style="background-color: #4d8076;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><strong>SPARKS BANK</strong> <img src="logos/tsf.png" width=40px heigth=40px/></a> 
    ...
    <class class="welcome">
        <h2 align=center>
            <br>
            <img src="logos/friend.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Welcoming you in the most trusted Sparks Bank !</strong> <img src="logos/trust.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
