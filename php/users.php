...
<body>
  ...
  <nav class="navbar py-2 navbar-expand-lg navbar-light" style="background-color: #4d8076;">
                ...
                <ul class="navbar-nav me-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item py-3">
                        <a class="nav-link" href="https://www.thesparksfoundationsingapore.org/ "
                            target="_blank"><strong>About</strong></a>
                    </li>
                    <li class="nav-item py-3">
    ...
    <class class="welcome">
        <h2 align=center>
            <br>
             <img src="logos/m1.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money Transfer</strong> <img src="logos/m2.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
